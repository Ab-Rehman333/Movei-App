...
function getMovei(searchText) {
    axios
        .get(`http://www.omdbapi.com/?s=${searchText}&apikey=7266afa0`)
        .then((res) => {
            ...
            $.each(moveis, (index, movei) => {
                ...
                <div class="col-md-3 col-sm-6 mt-4 ">
                    ...
                    <img src=${movei.Poster}>
                        ...
                        <a onclick="singleMovei('${movei.imdbID}')" class="btn btn-primary margin-top" href="#">Check Details</a>
                    </div>
                </div>
                `;
            });
...
function getMovie() {
    ...
    axios.get(`http://omdbapi.com/?i=${getItem}&apikey=7266afa0`).then(res => {
       let movie = res.data;
